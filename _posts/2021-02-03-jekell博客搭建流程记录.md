...
5. push后会在github的action看到进程，action进程成功完成后会在github分支中看到gh-pages分支；

6. [更改publishing source](https://github.com/cotes2020/jekyll-theme-chirpy/#deploy-on-github-pages)

进入 `https://<user_name>.github.io`，此时主页已初始配置完成。
